...
export default function Navbar({ 
  ...
  const isManagerOrStaff = currentUser && (currentUser.role === 'manager' || currentUser.role === 'staff');
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              >
                ...
                <span style={{ 
                  fontSize: '9px', 
                  fontWeight: 700, 
                  color: currentUser.role === 'manager' ? '#2e7d32' : currentUser.role === 'staff' ? '#f57c00' : 'var(--primary)',
              ...
              {/* Cổng Admin button (Hiển thị cho Manager & Staff) */}
              {isManagerOrStaff && (
                <button 
